		...
		profile_modal: {
			...
			billing: {
				...
				basic_plan: {
					...
					price: `$${PRICING_BASIC_PLAN_MONTHLY}/mês`,
					price_mo: `$${PRICING_BASIC_PLAN_MONTHLY}/mês`,
					features: [
				...
				premium_plan: {
					...
					price_mo: `$${PRICING_PREMIUM_PLAN_MONTHLY}/mês`,
					features: [
		...
		pages: {
			...
			pricing: {
				...
				billing: {
					monthly: "Mensal",
					yearly: "Anual",
					save_20: `Economize ${YEARLY_DISCOUNT_PERCENT}%`,
					no_contract:
