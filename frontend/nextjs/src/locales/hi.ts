...
export default {
	...
	resume_builder: {
		...
		pages: {
			analyzer: {
				header: {
					title: "रेज़्यूमे एनालाइज़र AI",
					description:
						"अपना रेज़्यूमे PDF प्रारूप में अपलोड करें और कृत्रिम बुद्धिमत्ता का उपयोग करके स्कोरिंग और सुधार सुझावों के साथ विस्तृत विश्लेषण प्राप्त करें।",
				},
				uploadSection: {
					title: "रेज़्यूमे अपलोड करें",
					form: {
						jobTitle: {
							label: "नौकरी का शीर्षक (वैकल्पिक)",
							placeholder: "उदा. सॉफ्टवेयर इंजीनियर, मार्केटिंग मैनेजर, पायलट",
							helperText:
								"नौकरी का शीर्षक जोड़ने से विश्लेषण विशिष्ट भूमिका आवश्यकताओं के लिए तैयार होगा",
						},
						fileUpload: {
							mainText: "अपनी PDF फ़ाइल यहाँ खींचें",
							secondaryText: "या चयन करने के लिए क्लिक करें",
							sizeRestriction: "अधिकतम आकार: 5MB • केवल PDF",
							selectedFile: "फ़ाइल चयनित",
						},
						error: {
							prefix: "त्रुटि: ",
						},
						submitButton: {
							default: {
								text: "AI के साथ रेज़्यूमे विश्लेषित करें",
								iconAlt: "फ़ाइल आइकन",
							},
							uploading: {
								text: "विश्लेषण किया जा रहा है...",
								iconAlt: "लोडिंग स्पिनर",
							},
						},
					},
					instructions: {
						title: "हम क्या विश्लेषण करते हैं?",
						items: [
							"रेज़्यूमे संरचना और स्वरूपण",
							"कीवर्ड और ATS अनुकूलन",
							"सामग्री स्पष्टता और संक्षिप्तता",
							"मात्रात्मक उपलब्धियाँ और मेट्रिक्स",
							"व्याकरण, वर्तनी और पेशेवर स्वर",
						],
					},
				},
				resultsSection: {
					...
					emptyState: {
						...
						description:
							"व्यक्तिगत स्कोरिंग और सुधार सुझावों के साथ विस्तृत विश्लेषण प्राप्त करने के लिए PDF प्रारूप में रेज़्यूमे अपलोड करें।",
						iconAlt: "फ़ाइल आइकन",
					},
					analysis: {
						overallScore: {
							...
							scoreSuffix: "/100",
							tailoredFor: "के लिए विश्लेषित: {jobTitle}",
						},
						aiFeedback: {
							title: "AI प्रतिक्रिया",
						},
						strengths: {
							title: "मजबूतियाँ",
							iconAlt: "चेक आइकन",
						...
						actionButtons: {
							print: "विश्लेषण प्रिंट करें",
							analyzeAnother: "दूसरा विश्लेषित करें",
						},
					},
				},
				icons: {
					fileText: "दस्तावेज़ आइकन",
					briefcase: "ब्रीफ़केस आइकन",
					upload: "अपलोड आइकन",
					alertCircle: "अलर्ट आइकन",
					checkCircle: "चेक मार्क आइकन",
					star: "स्टार आइकन",
					loader: "लोडिंग स्पिनर",
				},
				accessibility: {
					fileUploadArea:
						"फ़ाइल अपलोड क्षेत्र। PDF फ़ाइल का चयन करने के लिए खींचें और छोड़ें या क्लिक करें",
					jobTitleInput: "नौकरी शीर्षक इनपुट फ़ील्ड",
					uploadButton: "रेज़्यूमे अपलोड और विश्लेषण बटन",
				},
			},
			home: {
