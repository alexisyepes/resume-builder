...
type StandardATSSectionMapProps = {
	sectionRefs: SectionRefs
	t: Translation
	customTitles: Record<string, string>
	resumeData: ResumeSnapshot
	generatedResume: ResumeSnapshot
	template: string
}

export default function StandardATSSectionMap({
	sectionRefs,
	t,
	customTitles,
	resumeData,
	...
	const sectionMap: Record<string, ReactNode> = {
		[PERSONAL_DETAILS]: (
			<section ref={sectionRefs[PERSONAL_DETAILS]} className="mb-4">
				<div
					className={`relative ${
						template === "elegant" ? "text-left" : "text-center"
					}  pb-4 mb-4`}
				>
					{photo && (
						<div
							className={`w-16 h-16 ${
								template === "elegant" ? "" : "mx-auto"
							}  my-4 overflow-hidden rounded-full`}
						>
							<img
								src={photo}
