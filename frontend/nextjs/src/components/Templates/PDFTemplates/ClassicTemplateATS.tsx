...
const renderRichText = (htmlContent: string, customFontSize: number) => (
...
type ClassicTemplateATSProps = DocumentProps & {
	resumeData: ResumeExportData
	photo?: string
}

export const ClassicTemplateATS = ({
	resumeData,
	photo,
	...documentProps
}: ClassicTemplateATSProps): ReactElement<DocumentProps> => {
	console.log(photo)
